...
img:"./money.png",
desc:"I developed a Money Tracker Web App as part of my Bharat Intern Internship project. This app provides a robust platform for users to manage their income and expenses efficiently. Using HTML and CSS for the Front-End ensures a visually appealing and responsive user interface. To add functionality, I utilized JavaScript for client-side interactions and validations. On the server side, Node.js powers the Back-End operations, handling data processing and communication.  ",
demoLink: "https://www.linkedin.com/posts/dhrubojyoti-chakraborty-567857257_community-bharatintern-bharatinternship-activity-7177703662104797184-4MnD?utm_source=share&utm_medium=member_desktop",
},
];
